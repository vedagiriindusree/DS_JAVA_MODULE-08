...
3. For each incoming number in the stream: =>Increment its count in the map.
...
## Output:
<img width="318" height="71" alt="image" src="https://github.com/user-attachments/assets/9f4df9b3-0178-4008-8474-fb61e4cd16bf" />
